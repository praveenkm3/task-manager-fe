...
import { useRegister } from "../../reactQuery/hooks/authHooks";
...
export default function Register() {
  ...
  function handleSubmit() {
    ...
    mutate(
      {
        username: registerData?.username?.toLocaleLowerCase(),
        email: registerData?.email?.toLocaleLowerCase(),
        password: registerData?.password,
        adminSecretKey: registerData?.adminSecretKey,
      },
      {
        onSuccess: () => {
      ...
      >
        ...
        >
          ...
          <Box sx={{ display: "flex", justifyContent: "center" }}>
            <Typography variant="h5">Welcome to Registration</Typography>
          </Box>
        </Box>
